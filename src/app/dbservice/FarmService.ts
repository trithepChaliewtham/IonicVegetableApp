...
export class FarmService {
  ...
  // Updat vegetables in vegetables array lists
  updateFarmDetailVeg(getid, updatedata: any) {
    return this.ngFirestore.doc(`farm/'+${getid}+/vegetables`).update(updatedata);
  }
